...
Start with [your first manifest](../getting-started.md) to see the checks in a local example. Read [limitations](../limitations.md) before treating a signed declaration as evidence of runtime behavior.
